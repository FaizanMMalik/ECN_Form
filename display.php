...
<html lang="en-us">
 ...
 <?php
include ("db.php");
$sql="SELECT * FROM `ecndetails` WHERE ecnno='$_GET[id]'";
...
if(isset($_POST['send'])){
   ...
   $mail->SMTPAuth = true;
   $mail->Username = 'faizan2000m@gmail.com'; //your gmail 
   $mail->Password = 'hknqnwyvrdnzlmtn';  // your gmail app password
   $mail->SMTPSecure = 'ssl';
   $mail->Port = 465;

   $mail->setFrom('faizan2000m@gmail.com');  //your gmail
   
   $mail->addAddress('faizansuper@hotmail.com'); //Email of the reciever
...
<tr>
					...
					<td>
						...
						<input type="text" name="subject" id="subject" style=" border: 3px solid #ccc;">
						<br>
						<label for="body"><b>Body:</b> </label>
						<input type="text" name="body" id="body" style=" border: 3px solid #ccc;">
						<br>
						<button type="submit" style="width: 150px;height: 50px;background-color:yellow" name="send">Send the Email </button>
					</td>		
					...
					<a href=ecn-form.php style="font-size:40px">GO BACK</a>
					<!-- <button style="width: 150px;height: 50px;background-color:yellow" onclick="clip()"><b>Copy URL</b></button> -->
